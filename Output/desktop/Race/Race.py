...
def game_loop ():
    global highscore, delta, time, total_time,  collision_occurred, car_sprite, current_song_index, tree_sprite, current_environment_index, music_playing, cars, trees, enemy_position_offset
    screen = pygame.display.set_mode (screen_size, pygame.SCALED)
    pygame.display.set_caption ("Don't Crash!!!")
